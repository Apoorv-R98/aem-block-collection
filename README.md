# aem-block-collection (Content AI Search fork)
Frontend block for the EDS Content AI Search initiative (Jira GRANITE-71249). Phase 1 of 3: frontend only, backed by local mock data unless a real Content AI backend is authored on the block instance.
